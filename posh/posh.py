...
# pipe().a().b().end()
#  pipe sets pipe = true
#  a sees pipe == true, saves a command to be run later
#  b runs a. gets stdout or stderr from a for stdin, saves b command for later
#  end runs b command. returns sh 

# pipe().a().b().redir(..)
#  a runs when b is called
#  b runs when redir is called
#  before redir runs b, it swaps out any files

# a()
#  a runs when it's called

# bg().a()
#  bg tells us the next command should be backgrounded
#  a runs when it's called

# redir().a()
#  redir is not in a pipe, so it waits until a is called
#  a runs when it's called
...
# pipe().a().b().var()
#  == pipe().a().b().redir(stdout=VAR)
#  var() returns a string

# var().a().b()
#  == INVALID - var().a() returns a string

# exe-with-invalid-name()
#   fails invalid name

# sh['exe-with-invalid-name()']
#  run 'exe-with-invalid-name'
